...
import ./osseps; export osseps
import ./envvars
import ./osappdirs
import pathnorm
from   ./ospaths2 import 
  joinPath, splitPath, ReadDirEffect, WriteDirEffect, isAbsolute, relativePath, normalizePathEnd, isRelativeTo, parentDir, tailDir, isRootDir, parentDirs, `/../`,
  extractFilename, lastPathPart, changeFileExt, addFileExt, cmpPaths, splitFile, unixToNativePath, absolutePath, normalizeExe, normalizePath, getCurrentDir
...
template endsWith(a: string, b: set[char]): bool =  a.len > 0 and a[^1] in b
